        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +995-598-610-999</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> support@estore.ge</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i> Sololaki, Tbilisi</a></li>
                </ul>
                    ...
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <ul class="footer-links">
                                <li><a href="#"><i class="fa fa-map-marker"></i>Sololaki, Tbilisi</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>+995-598-610-999</a></li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i>email@estore.ge</a></li>
                            </ul>
                        </div>
                    </div>
